function mainfunction() {
    ...
    itemType.addEventListener('click', selectItem);
...
function selectItem() {
    ...
    if (itemType.value === "f") {
        ...
        var foodItems = ["Hamburger", "Pizza", "Coffee", "Chicken Nuggets", "Bread", "Tea", "Soda", "Cake", "Ice Cream"];
    ...
    if (itemType.value === "cl") {
        ...
        var clothesItems = ["T-Shirt", "Coat", "Sweater", "Jacket", "Shorts", "Jeans", "Trousers", "Shoes", "Socks"];
    ...
    if (itemType.value === "tch") {
        ...
        var techItems = ["Desktop PC", "Laptop", "Processor", "Graphic Card", "Ram", "iPhone", "Samsung", "Television", "Radio", "Speakers"];
    ...
    if (itemType.value === "c") {
        ...
        var carsItems = ["Audi", "BMW", "Volkswagen", "Mercedes", "Porsche", "Ferrari", "Lamborghini", "Bugatti"];
    ...
    if (itemType.value === "l") {
        ...
        var libraryItems = ["Book", "Notebook", "Magazine", "Pencil", "Pen", "Rubber", "Ruler", "Colour Pen"];
    ...
    if (itemType.value === "o") {
        ...
        var otherItems = ["Lawn Mower", "Ball", "Tennis Racket", "Shovel", "Vase", "Couch", "Chair", "Blanket", ];
